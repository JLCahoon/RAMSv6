        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li class="active">
                        <a href="list_files.php"><i class="glyphicon glyphicon-folder-open"></i> Knowledge Base</a>
                    </li>
                    <li>
...
$dbLink = new mysqli('localhost:8889', 'root', 'root', 'RiskManagement');
        ...
        while($row = $result->fetch_assoc()) {
            echo "
                <tr>
                    ...
                    <td>{$row['size']}</td>
                    <td>{$row['created']}</td>
                    <td><a href='get_file.php?id={$row['id']}'><img src='../img/downloadimage.png' width='20px' height='20px'></a></td>
                </tr>";
        }
