...
<body>
    ...
    <div id="wrapper">
        ...
        <!-- Navigation -->
        <nav style="background:blue;" role="navigation">
            <!-- Brand and toggle get grouped for better mobile display -->
            <div class="navbar-header" style="background:blue;">
            ...
            <!-- Top Menu Items -->
            <ul class="" style="background:blue;">
                <li class="dropdown">
                            ...
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        <div class="huge"><?php
$mysqli = new mysqli("localhost:8889", "root", "root", "RiskManagement");
